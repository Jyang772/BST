...
int main()
{
  ...
  /*  ifstream file;
    ...
    while(!done){
		...
		cout << "[8] Get People With Average\n";
		cout << "[9] Get People With Max Average\n";
		cout << "[10] Get People With Major\n";
		cout << "[11] Get Tree Height\n";
		cout << "[12] Print By Level\n";
        ...
        case 7:
            ...
            break;
        case 8:
			menu.getPeopleWithAvg();
			break;
		case 9:
			menu.getPeopleWithMaxAvg();
			break;
		case 10:
			menu.getPeopleWithMajor();
			break;
		case 11:
			menu.getHeight();
			break;
